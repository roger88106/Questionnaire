...
namespace Questionnaire.FrontPages
{
    public partial class StatisticalData : System.Web.UI.Page
    {
        ...
        RespondentManager _respondentManager = new RespondentManager();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (_respondentManager.GetRespondentList(questionnairesID).Count() == 0)
                {
                ...
                else
                {
                    ...
                    {
                        Literal1.Text = "<h4>這個問卷沒有問題可以統計</h4>";
                    }
                }
            }
